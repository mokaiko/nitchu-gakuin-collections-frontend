                                                        ...
                                                        : "menu-btn", onClick: () => setAdminSection("contract"), children: [_jsx("span", { className: "icon icon-contract", "aria-hidden": "true" }), " ", "\u30B3\u30F3\u30C8\u30E9\u30AF\u30C8\u7BA1\u7406"] })] }), _jsxs("div", { className: "admin-body", children: [_jsxs("div", { className: "notice", children: [_jsxs("div", { children: ["\u73FE\u5728\u306E\u63A5\u7D9A: ", account ?? "未接続"] }), _jsxs("div", { children: ["\u63A5\u7D9A\u306E\u6A29\u9650:", " ", isOwner ? "オーナー" : isAdmin ? "管理者" : "なし"] })] }), txMessage ? _jsx("div", { className: "notice", children: txMessage }) : null, adminSection === "info" ? (_jsxs("div", { className: "admin-section", children: [_jsx("h3", { children: "\u30B3\u30F3\u30C8\u30E9\u30AF\u30C8\u60C5\u5831" }), _jsxs("p", { children: ["\u30CD\u30C3\u30C8\u30EF\u30FC\u30AF: ", network.name] }), _jsxs("p", { children: ["\u30A2\u30C9\u30EC\u30B9: ", network.contractAddress] }), _jsxs("p", { children: ["Owner: ", ownerAddress ?? "取得中"] }), _jsxs("p", { children: ["\u30D0\u30FC\u30B8\u30E7\u30F3: ", contractVersion ?? "取得中"] })] })) : null, adminSection === "create" ? (_jsxs("div", { className: "admin-section", children: [_jsx("h3", { children: "\u65B0\u898F\u30B3\u30EC\u30AF\u30B7\u30E7\u30F3\u4F5C\u6210" }), _jsxs("div", { className: "form-grid", children: [_jsxs("label", { children: ["\u540D\u524D", _jsx("input", { value: formCreate.name, onChange: (e) => setFormCreate({
                                                                        ...
                                                                        gap: 8,
                                                                                ...
                                                                                flexWrap: "wrap",
                                                                                        ...
                                                                                        ...whitelistCheck,
                                                                                        tokenId: e.target.value,
                                                                                    }) }), _jsx("input", { className: "input-inline", style: { flex: "2 1 220px" }, placeholder: "\u30A6\u30A9\u30EC\u30C3\u30C8\u30A2\u30C9\u30EC\u30B9", value: whitelistCheck.address, onChange: (e) => setWhitelistCheck({
                                                                                        ...whitelistCheck,
                                                                                ...
                                                                                ...formWhitelist,
                                                                                tokenId: e.target.value,
                                                                            }) })] }), _jsxs("label", { children: ["\u30A2\u30C9\u30EC\u30B9\uFF08\u30AB\u30F3\u30DE\u533A\u5207\u308A\uFF09", _jsx("textarea", { rows: 2, value: formWhitelist.addresses, onChange: (e) => setFormWhitelist({
                                                                                ...formWhitelist,
                                                                        ...
                                                                        if (formWhitelist.mode === "add") {
                                                                            ...
                                                                            await c.removeFromWhitelist(Number(formWhitelist.tokenId), list);
                                                                            ...
                                                                            }) }), _jsxs("span", { className: "hint", children: ["\u5165\u529B\u4E0A\u9650: \u7D0430KB\uFF08", MAX_CHUNK_CHARS, "\u6587\u5B57\u76EE\u5B89\uFF09"] })] }), _jsxs("div", { style: { display: "flex", gap: 8 }, children: [_jsx("button", { className: "btn", disabled: !formSvg.tokenId || !formSvg.chunkData, onClick: () => withTx(async (c) => {
                                                                            ...
                                                                            }), children: "\u30B9\u30C6\u30C3\u30D71: \u30C1\u30E3\u30F3\u30AF\u8FFD\u52A0" }), _jsx("button", { className: "btn btn-secondary", disabled: !formSvg.tokenId, onClick: () => withTx(async (c) => {
                                                                                ...
                                                                                ...formAirdrop,
                                                                                tokenId: e.target.value,
                                                                            }) })] }), _jsxs("label", { children: ["\u53D7\u53D6\u30A2\u30C9\u30EC\u30B9\uFF08\u30AB\u30F3\u30DE\u533A\u5207\u308A\uFF09", _jsx("textarea", { rows: 2, value: formAirdrop.recipients, onChange: (e) => setFormAirdrop({
                                                                                ...formAirdrop,
                                                                ...
                                                                gap: 8,
                                                                            ...
                                                                            ? "管理者です"
                                                                            : "管理者ではありません"] })) : null] }), _jsxs("div", { className: "form-grid", children: [_jsxs("label", { children: ["\u30A2\u30C9\u30EC\u30B9", _jsx("input", { className: "input-inline", value: formAdmins.address, onChange: (e) => setFormAdmins({
                                                                                ...formAdmins,
                                                                                address: e.target.value,
                                                                    ...
                                                                    }), children: "\u5B9F\u884C" })] })] })) : null, adminSection === "contract" ? (_jsxs("div", { className: "admin-section", children: [_jsx("h3", { children: "\u30B3\u30F3\u30C8\u30E9\u30AF\u30C8\u7BA1\u7406\uFF08\u30AA\u30FC\u30CA\u30FC\u306E\u307F\u64CD\u4F5C\u53EF\u80FD\uFF09" }), _jsxs("p", { children: ["\u73FE\u5728\u306E\u72B6\u614B:", " ", isPaused === undefined
                                                                    ? "取得中"
                                                                    : isPaused
                                                                        ? "一時停止中"
                                                                        : "稼働中"] }), _jsxs("div", { style: { display: "flex", gap: 10, flexWrap: "wrap" }, children: [_jsx("button", { className: "btn", disabled: !isOwner || isPaused, onClick: () => withTx(async (c) => {
                                                                        if (!isOwner) {
                                                                        ...
                                                                        await c.pause();
                                                                        setIsPaused(true);
                                                                    }), children: "\u7DCA\u6025\u505C\u6B62 (pause)" }), _jsx("button", { className: "btn btn-secondary", disabled: !isOwner || isPaused === false, onClick: () => withTx(async (c) => {
                                                                        if (!isOwner) {
                                                                            setError("オーナーのみ実行できます。");
                                                                            return;
                                                                        }
                                                                        await c.unpause();
                                                                        setIsPaused(false);
                                                                    }), children: "\u518D\u958B (unpause)" }), !isOwner ? (_jsx("div", { className: "hint", children: "\u203B \u30AA\u30FC\u30CA\u30FC\u306E\u307F\u5B9F\u884C\u53EF\u80FD" })) : null] })] })) : null] })] })) : null] })] }) }), _jsx(SiteFooter, {})] }));
}
